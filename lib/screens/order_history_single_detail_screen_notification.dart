...
class OrderHistorySingleDetailScreenNotification extends StatefulWidget {
  @override
  _OrderHistorySingleDetailScreenNotificationState createState() =>
      _OrderHistorySingleDetailScreenNotificationState();
}

class _OrderHistorySingleDetailScreenNotificationState
    extends State<OrderHistorySingleDetailScreenNotification> {
  ...
  Future<void> getDataFromServer() async {
    ...
    OrderHistoryModel orderHistoryModel =
        await OrderHistoryRepository().getOrderHistoryById(orderId.toString());
    orderHistory = orderHistoryModel.orderHistory.first;
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    //     itemCount: orderHistory.orderItem.length,
                    //     itemBuilder: (BuildContext context, int index) => CartRow(
                    //       screenSize: screenSize,
                    //       orderItem: orderHistory.orderItem[index],
                    //     ),
                    //   ),
                    // ),
