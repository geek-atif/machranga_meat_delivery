...
class ProductDetailScreenNotification extends StatefulWidget {
  @override
  _ProductDetailScreenNotificationState createState() =>
      _ProductDetailScreenNotificationState();
}

class _ProductDetailScreenNotificationState
    extends State<ProductDetailScreenNotification> {
  ...
  Future<void> getDataFromServer() async {
    ...
    ProductListModel productListModel = await HomeRepository()
        .getProductById(productId.toString(), userId.toString());
    productModel = productListModel.productModels.first;
    setState(() {
      _isLoading = false;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: _isLoading
          ...
          : displayScreen(context, productModel, screenSize),
    );
  }
