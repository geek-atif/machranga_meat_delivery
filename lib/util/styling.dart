...
class AppTheme {
  ...
  static const Color redButtonColor = Color(0xFFDD2121);
  static const Color gryButtonColor = Color(0xFFE3E3E3);
  static const Color gryTextColor = Color(0xFF6B6B6B);
  static const Color boxShadow = Color.fromRGBO(0, 0, 0, 0.1);
  static const Color serachColor = Color(0xFFC9C9C9);
  static const Color arrowColor = Color(0xFFE5E5E5);
  static const Color processingColor  = Color(0xFFF99524);
