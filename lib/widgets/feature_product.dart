...
import 'package:Machranga/models/product_model.dart';
    ...
    return Container(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            if (productModel[index].is_featured == 1) {
              return HorizontalRowProduct(
                screenSize: screenSize,
                productModel: productModel[index],
                cartQuantityModel: cartQuantityModels.firstWhere((element) =>
                    element.productId == productModel[index].productId , orElse: () => null),
              );
            } else {
              return Text('');
            }
